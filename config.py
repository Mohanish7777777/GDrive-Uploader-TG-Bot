...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = "6256403709:AAH9r5v2vOVoSlFbnLJTVJNobNoXSS7PyXQ" # Get it from https://t.me/BotFather
    TELEGRAM_API = "20244111"
    TELEGRAM_HASH = "b76d27da2a4220fe109fe9ef0e866530" # Get it from my.telegram.org/apps
